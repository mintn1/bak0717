		   ...
		   Statement stmt = null;	
		    ...
		    Context initCtx = new InitialContext(); 
		  	...
		  	if(ds!=null){  
		  		 ...
		  		 String t1=request.getParameter("titlename");
		  		 String s1=request.getParameter("sheetname");
		  		 String u1=request.getParameter("uploaddate");
		  		 
		  		 
		  		 String sql = "select *  from Tquestions where " +
		  		 			"titlename='" + t1 + "' and " +
		  		 			"sheetname='" + s1 + "' and " +
		  		 			"uploaddate='" + u1 +"' "; 
